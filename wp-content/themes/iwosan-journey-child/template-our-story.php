<?php
/**
 * Template Name: Iwosan Our Story
 * Description: Custom coded Our Story page for Iwosan Journey's
 */
...
<div class="ij-section">
	...
	<h2>The kitchen table moment</h2>
	<p>The second realization was personal, not professional.</p>
	<p>About a year before our wedding, I began experiencing the sudden onset of menopausal symptoms — and it opened a chasm between my now-husband LaDon and me that neither of us expected. We were navigating confusion, systemic medical silence, and a near-total absence of non-clinical support, together but not really together, because no one had given us the language for what was happening.</p>
	...
	<p>Iwosan Journey's carries that mission forward through:</p>
	<ul>
		<li><strong>Advocacy</strong> — <a href="/advocacy/">Patient Power Packs</a> that equip you to walk into any clinical space ready to be heard.</li>
		<li><strong>Health</strong> — grounded, accessible <a href="/health/">education on men's health and mental wellness</a>, meeting people exactly where they are.</li>
		<li><strong>Experiences</strong> — <a href="/experiences/">Global Sanctuaries</a>, our vetted network of JCI-accredited medical travel partners, plus live Mini-Conferences and Immersion Retreats.</li>
	</ul>
	<p><em>For dedicated menopause education and community, visit our sister platform, <a href="/menopause/">MenoWell</a>.</em></p>

	<p>We're not doctors, and nothing here replaces the care of your own physician. What we are is the safety net we wished we'd had — built so no one has to figure this out alone.</p>
